How to contribute to Cozy Crédit Coopératif Konnector?
======================================================
...
- What is the version of the Cozy Crédit Coopératif Konnector?
...
```
$ git clone github.com/carrieje/cozy-konnector-crcoop.git
$ cd cozy-konnector-crcoop
$ git remote add fork git://github.com/yourusername/cozy-konnector-crcoop.git
```
...
Go to https://github.com/yourusername/cozy-konnector-crcoop and select your branch. Click the 'Pull Request' button and fill out the form.
...
[issues]: https://github.com/carrieje/cozy-konnector-crcoop/issues/new
